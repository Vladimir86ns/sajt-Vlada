<template>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="logo span3">
          ...
          <a class="brand" href="#"><img src="../assets/img/logo.png" alt="Logo"></a>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="span3">
          ...
          <h3>We are here!</h3>
          <div id="small-map-container"><a href="/contact"></a></div>

          <iframe id="small-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d22464.391948803073!2d19.806437751451355!3d45.26702039013613!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475b10613de93455%3A0xb6f7d683724fe28!2z0J3QvtCy0Lgg0KHQsNC0!5e0!3m2!1ssr!2srs!4v1511955851168" width="210" height="210" frameborder="0" style="border:0" allowfullscreen></iframe>
  ...
  <div id="copyright">
    ...
    <div class="container">
      ...
      <p>
        &copy; 2013, creativeLabs. <a href="http://bootstrapmaster.com" alt="Bootstrap Themes">Bootstrap Themes</a> designed by BootstrapMaster in Poland <img src="../assets/img/poland2.png" alt="Poland" style="margin-top:-4px">
      </p>
